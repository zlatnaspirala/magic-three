...
var PointerLockControls = function(camera, domElement) {
  ...
  this.connect = function() {
    ...
    if(App.config.playerController.mobile.hudControls == true) {
      ...
      byId('domAngleAxis').addEventListener('touchmove', arrayTouches, false);
      byId('domAngleAxis').addEventListener('touchend', onTouchEnd, false);
    } else {
  ...
  this.disconnect = function() {
    if(App.config.playerController.mobile.hudControls == true) {
      byId('domAngleAxis').removeEventListener('mousemove', onMouseMove, false);
      byId('domAngleAxis').removeEventListener('touchmove', arrayTouches, false);
      byId('domAngleAxis').removeEventListener('touchend', onTouchEnd, false);
      byId('domAngleAxis').removeEventListener('touchmove', onTouchMove, false);
    } else {
