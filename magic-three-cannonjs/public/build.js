...
class Magic extends _magicCore.MagicThree {
  ...
  useMyLoaders() {
    return new Promise(resolve => {
      this.loaders = new _magicLoader.MagicThreeLoader(this.scene, this.camera);
...
class MagicThreeLoader {
  ...
  async run() {
    return new Promise((resolve, reject) => {
      ...
      m.push(new Promise((resolve, reject) => {
        (0, _magicUtils.runScript)('./js/loaders/FBXLoader.js').then(a => {
          resolve('FBX Loader ready');
        });
      }));
      m.push(new Promise((resolve, reject) => {
        (0, _magicUtils.runScript)('./js/loaders/ColladaLoader2.js').then(a => {
          resolve('COLLADA Loader ready');
        });
      }));
      m.push(new Promise((resolve, reject) => {
        (0, _magicUtils.runScript)('./js/loaders/collada/Animation.js').then(a => {
          resolve('COLLADA Loader ready');
        });
      }));
      m.push(new Promise((resolve, reject) => {
        (0, _magicUtils.runScript)('./js/loaders/collada/AnimationHandler.js').then(a => {
          resolve('COLLADA Loader ready');
        });
      }));
      m.push(new Promise((resolve, reject) => {
        (0, _magicUtils.runScript)('./js/loaders/collada/KeyFrameAnimation.js').then(a => {
          resolve('COLLADA Loader ready');
        });
      }));
  ...
  loadObj(path_to_obj, obj_name, mtl_, options) {
    if ((0, _magicUtils.is)(options) == false) var options = {};
    if ((0, _magicUtils.is)(options.scale) == false) options.scale = 1;
    if ((0, _magicUtils.is)(options.position) == false) options.position = new THREE.Vector3(0, 1, 0);
